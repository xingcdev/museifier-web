...
interface MuseumVisitsProps extends BoxProps {
	visits: {
		id: string;
		title: string;
		visitDate: string;
...
export function MuseumVisits({ visits, ...props }: MuseumVisitsProps) {
		...
		<Box {...props}>
			{visits.length > 0 ? (
				...
				<NoSearchResultsFound>
					<Typography>Il semblerait que vous n'ayez aucune visite.</Typography>
				</NoSearchResultsFound>
			)}
		</Box>
	);
